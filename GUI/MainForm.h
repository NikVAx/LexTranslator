...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SyntaxPage->Text = L"Cинтаксическое дерево";
			...
			this->Text = L"ИС-42 Ванчугов С.М. Вариант 4";
...
#pragma endregion
	private: System::Void FileBtn_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (!System::String::IsNullOrWhiteSpace(fileName)) {
			...
			MessageBox::Show(this, "Выбор файла был отменен!", "Cообщение");
		}
	}
	...
	private: System::Void ExecuteBtn_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		//triadOpt1.reduce();
		//if (triadOpt1.error) {
		//	MessageBox::Show(this, gcnew String(triadOpt1.message.c_str()), "������");
		//	return;
		//}
		//
	...
	private: void parseResultError(std::string& source, ParseResult& result) {
		...
		ss << "Встречена ошибка на этапе \"Лексический анализ\":\n\n"
			<< "В столбце: " << index << ";\n"
			<< "Входной символ \'" << inputChar << " \'(ASCII:" << (int)inputChar << ")\n\n"
