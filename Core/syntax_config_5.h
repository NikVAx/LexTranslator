...
namespace SyntaxRules
{
    ...
    const SyntaxRule R4 = SyntaxRule(BuildRule({ SyntaxChars::NONTERMINAL, SyntaxChars::MULTIPLY, SyntaxChars::NONTERMINAL }));
    const SyntaxRule R5 = SyntaxRule(BuildRule({ SyntaxChars::NONTERMINAL, SyntaxChars::DIVIDE, SyntaxChars::NONTERMINAL }));
    const SyntaxRule R7 = SyntaxRule(BuildRule({ SyntaxChars::OPEN_BRACKET, SyntaxChars::NONTERMINAL, SyntaxChars::CLOSE_BRACKET }));
    const SyntaxRule R8 = SyntaxRule(BuildRule({ SyntaxChars::MINUS, SyntaxChars::OPEN_BRACKET, SyntaxChars::NONTERMINAL, SyntaxChars::CLOSE_BRACKET }));
    const SyntaxRule R9 = SyntaxRule(BuildRule({ SyntaxChars::IDENTIFIER }));
}
